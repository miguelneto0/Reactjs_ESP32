...
<p align = "left"><sup>
Image 1 (Hardware settings)</sup></p>
...
<p align = "left"><sup>Image 2 (Initial code C-like with includes and defines) and Image 3 ("Conectar" function)</sup></p>
...
<p align = "left"><sup>Image 4 (Setup function)</sup></p>
...
Thus, after these steps, chose a folder to create the application project, for example, if you create a folder named "mobileApp", you must enter in this folder and run the following command:
  ...
  In this way, a structure will be created containing all resources for running the app. This structure can be observed on the left side of the Image 5 below. In addition, for running the app we have using the command:
...
<p align = "left"><sup>Image 5 (Project structure and imports and first statements in App.js code)</sup></p>
...
<p align = "left"><sup>Image 6 (Return code), Image 7 (Styles CSS code) and Image 8 (Smartphone print)</sup></p>

The result of the project is shown in the following animation:
